  ...
  useEffect(() => {
    const fetchWaitingListData = async () => {
      ...
      const initialMockWaitingListData: MockListItem[] = [
        { id: "WL001", patientName: "Alice Wonderland", gender: "Female", timeAdded: "10:30 AM", location: localT('visitingPatients.visitDetails.department.outpatient'), status: "Waiting for Doctor", photoUrl: "https://placehold.co/32x32.png" },
        { id: "WL002", patientName: "Bob The Builder", gender: "Male", timeAdded: "10:45 AM", location: localT('visitingPatients.visitDetails.department.specialist'), status: "With Doctor", photoUrl: "https://placehold.co/32x32.png" },
      ];
  ...
  useEffect(() => {
    const fetchDraftsData = async () => {
      ...
      const initialMockDraftedConsultationsData: DraftedConsultationItem[] = [
        { id: "DRAFT001", patientName: "Edward Scissorhands", gender: "Male", reasonForDraft: localT('consultationRoom.drafts.mock.reason1'), lastSavedTime: "Yesterday 04:30 PM", photoUrl: "https://placehold.co/32x32.png" },
        { id: "DRAFT002", patientName: "Fiona Gallagher", gender: "Female", reasonForDraft: localT('consultationRoom.drafts.mock.reason2'), lastSavedTime: "Today 09:15 AM", photoUrl: "https://placehold.co/32x32.png" },
      ];
