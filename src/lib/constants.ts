...
export const COMMON_ORDERABLE_LAB_TESTS: OrderableLabTest[] = [
  ...
  { id: "glucose_random", label: "Glucose, Random", category: "Chemistry" }, // Random, as fasting might not be assumed for all orders
  ...
  { id: "ldl_cholesterol_calculated", label: "LDL Cholesterol (Calculated)", category: "Lipids" }, // Or direct if available
...
export const MATERNITY_SPECIFIC_LAB_TESTS: OrderableLabTest[] = [
  // Subset of common tests often specifically ordered in maternity context
  { id: "cbc_mat", label: "Complete Blood Count (CBC)", category: "Hematology" }, // Could be a panel if backend supports it
  ...
  { id: "vdrl_rpr_mat", label: "VDRL/RPR (Syphilis Test)", category: "Serology" },
  { id: "hbsag_mat", label: "Hepatitis B Surface Antigen (HBsAg)", category: "Serology" },
